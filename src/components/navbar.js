...
const Navbar = () =>{
    return(
        <navbar className="nav_container flex-col  flex items-center justify-center">
                ...
                <a href='/certifications' className="  p-6 mt-5 mb-5 rounded-[100%] bg-[#555] text-[2.4rem] transition-all ease-in hover:scale-[1.1] hover:bg-[#f46767] flex items-center justify-center visited:text-[#fff5fd]"><ion-icon name="albums"></ion-icon></a>
