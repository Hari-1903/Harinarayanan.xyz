...
export const experiences = [
  {
    ...
    desc: "Utilized advanced data analysis techniques, encompassing data preprocessing, exploratory data analysis, and machine learning algorithms, to address four real-world problems. Devised 2 distinct models and engaged with datasets to address foundational forecasting and prediction, leading to improved decision-making processes.",
    skills: [
      "Python",
      "Jupyter Notebook",
      "Data Analysis",
...
export const education = [
  {
    ...
    grade: "9.34 CGPA",
    desc: "Pursuing an impactful coursework at SRMIST, I've delved into significant subjects like AIML, DSA, OOPS, and Computer Organization and Architecture. Currently holding a commendable 9.34 CGPA, I'm dedicated to mastering the intricacies of these domains, laying a strong foundation for my journey in computer science.",
